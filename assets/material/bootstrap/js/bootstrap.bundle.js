  ...
  */
  ...
  function preventOverflow(_ref) {
    ...
    var _options$mainAxis = options.mainAxis,
      ...
      _options$tetupperffset = options.tetupperffset,
      tetupperffset =
        _options$tetupperffset === void 0 ? 0 : _options$tetupperffset;
    var overflow = detectOverflow(state, {
      boundary: boundary,
      rootBoundary: rootBoundary,
      padding: padding,
    ...
    var referenceRect = state.rects.reference;
    var popperRect = state.rects.popper;
    var tetupperffsetValue =
      typeof tetupperffset === "function"
        ? tetupperffset(
            Object.assign({}, state.rects, {
              placement: state.placement,
            })
    ...
    if (checkMainAxis || checkAltAxis) {
      ...
      var minOffset = isBasePlacement
        ? referenceRect[len] / 2 -
          ...
          arrowPaddingMin -
          tetupperffsetValue
        : minLen - arrowLen - arrowPaddingMin - tetupperffsetValue;
      var maxOffset = isBasePlacement
        ? -referenceRect[len] / 2 +
          ...
          arrowPaddingMax +
          tetupperffsetValue
        : maxLen + arrowLen + arrowPaddingMax + tetupperffsetValue;
