...
(function (window, factory) {
  ...
  // cache all material properties that could have material prefix
  ...
  proto.css = function (style) {
    ...
    for (var prop in style) {
      ...
      var supportedProp = materialProperties[prop] || prop;
  ...
  proto.enableTransition = function (/* style */) {
    ...
    //   prop = materialProperties[ prop ] || prop;
  ...
  proto.ontransitionend = function (event) {
    ...
    var propertyName =
      dashedmaterialProperties[event.propertyName] || event.propertyName;
